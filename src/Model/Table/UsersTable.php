 ...
 * @property \Cake\ORM\Association\BelongsTo $BounteeUsers
 * @property \Cake\ORM\Association\HasMany $ManualAwards
 * @property \Cake\ORM\Association\HasMany $PromotionAwards
 * @property \Cake\ORM\Association\HasMany $ResellerProgramUsers
...
class UsersTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        // $this->belongsTo('BounteeUsers', [
        //     'foreignKey' => 'bountee_user_id'
        // ]);
    ...
    public function buildRules(RulesChecker $rules)
    {
        ...
        // $rules->add($rules->existsIn(['bountee_user_id'], 'BounteeUsers'));
